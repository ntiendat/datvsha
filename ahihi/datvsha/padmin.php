...
<form action="signup.php" method="POST" >
            ...
            <form action="xoabai.php">
            <input style=" border-radius: 10px" type="submit" value="Xóa Bài" >  
            </form>
            <form action="timbai.php">
            <input style=" border-radius: 10px" type="submit" value="Tìm" >  
            </form>
            <form action="thbaiviet.php">
            <input style=" border-radius: 10px" type="submit" value="DS bài viết" >  
            </form>
            <form action="chonbv.php">
            <input style=" border-radius: 10px" type="submit" value="Chọn Bài Viết" >  
            </form>
